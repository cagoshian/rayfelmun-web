...
const inter = localFont({
    src: "../public/fonts/InterVariable.woff2", weight: "100 900", style: "normal",
});

export const metadata = {
    metadataBase: new URL("https://rayfelmun.com"),
    title: {
        default: "Rayfelmun'25", template: "%s | Rayfelmun'25",
    },
    ...
    openGraph: {
        ...
        images: [{
            url: "/images/logo.png", width: 800, height: 600, alt: "Rayfelmun'25 Logo",
        },],
        locale: "en_US",
        type: "website",
    },
...
const jsonLd = {
    ...
    "location": {
        "@type": "Place", "name": "Ramazan Yaman Fen Lisesi", "address": {
            "@type": "PostalAddress",
    ...
    "image": ["https://rayfelmun.com/images/logo.png"],
    "description": "Ramazan Yaman Fen Lisesi Model United Nations Conference"
};
