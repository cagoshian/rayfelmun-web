        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              ...
              <ul>
                <li>
                  <Link href="/" className="mb-4 inline-block text-base font-medium text-body-color hover:text-white">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="mb-4 inline-block text-base font-medium text-body-color hover:text-white">
                    About
                  </Link>
                </li>
                <li>
                  <Link href="/schedule" className="mb-4 inline-block text-base font-medium text-body-color hover:text-white">
                    Schedule
                  </Link>
                </li>
              </ul>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-12 lg:mb-16">
              ...
              <ul>
                <li>
                  <Link href="/faq" className="mb-4 inline-block text-base font-medium text-body-color hover:text-white">
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="mb-4 inline-block text-base font-medium text-body-color hover:text-white">
                    Contact
                  </Link>
                </li>
              </ul>
