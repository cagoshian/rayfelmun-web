    ...
    <>
      ...
      >
        ...
        <div className="bg-primary/10 py-3">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Developed By{" "}
              <a href="https://github.com/doctormaster1" rel="nofollow noopener">
                Ahmet Esad Barut
              </a>
            </p>
          </div>
        ...
        {/* <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#FBB040" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#FBB040" stopOpacity="0.62" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#FBB040" stopOpacity="0" />
                <stop offset="1" stopColor="#FBB040" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
