export const committeeData = {
	unesco: {
		title: "UNESCO",
		subTitle: "Cultural Heritage and World Heritage Sites",
		imageSrc: "/images/unesco.jpeg",
		description: "Within the esteemed United Nations Educational, Scientific and Cultural Organization committee, delegates will be discussing the importance of World Heritage Sites, the unique aspects of their cultural heritages, and the international organizations established to cover these valuable treasures.",
		pdfLink: "/pdf/unesco-guide.pdf"
	},
	
	legal: {
		title: "LEGAL",
		subTitle: "Gender Equality and Women's Rights",
		imageSrc: "/images/legal.jpeg",
		description: "As the LEGAL Committee, we advocate for gender equality and the protection of women’s rights worldwide. Our mission is to address issues such as gender-based violence, discrimination, and barriers to education, health, and leadership. Through collaboration and diplomacy, we work to create inclusive, lasting solutions that empower women and ensure equal opportunities for all.",
		pdfLink: "/pdf/legal-guide.pdf"
	},
	
	interpol: {
		title: "INTERPOL",
		subTitle: "The International Criminal Police Organization",
		imageSrc: "/images/interpol.jpg",
